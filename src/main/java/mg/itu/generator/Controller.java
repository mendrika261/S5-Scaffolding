...
public class Controller extends Scaffolding {
    public Controller(HashMap<String, String> params, HashMap<String, String> languageParams, HashMap<String, Mapping> languageMappings, String packageName, Table table, Provider provider, Database database) {
    ...
    protected String process(String code) {
        return super.process(
                code
                        .replace("#datasource#", processDatasource())
                        .replace("#save_annotation#", getParams().get("#save_annotation#"))
                        .replace("#read_all_annotation#", getParams().get("#read_all_annotation#"))
                        .replace("#read_all_annotation_pagination#", getParams()
                                .get("#read_all_annotation_pagination#"))
                        .replace("#read_annotation#", getParams().get("#read_annotation#"))
                        .replace("#update_annotation#", getParams().get("#update_annotation#"))
                        .replace("#delete_annotation#", getParams().get("#delete_annotation#"))
                        .replace("#save_process#", getParams().get("#save_process#"))
                        .replace("#read_all_process#", getParams().get("#read_all_process#"))
                        ...
                        .replace("#request_body_annotation#", getParams().get("#request_body_annotation#"))
                        .replace("#path_variable_annotation#", getParams().get("#path_variable_annotation#"))
