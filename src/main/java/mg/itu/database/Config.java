...
public class Config {
    ...
    public Database getConnexion(String name) {
    ...
    public HashMap<String, HashMap<String, HashMap<String, String>>> getGenerations() {
        return generations;
    }

    public void setGenerations(HashMap<String, HashMap<String, HashMap<String, String>>> generations) {
